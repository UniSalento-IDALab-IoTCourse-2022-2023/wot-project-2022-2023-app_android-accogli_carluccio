...
//    lateinit var safetyScannerViewModel: SafetyScannerViewModel
...
//            safetyScannerViewModel.checkIncomingBeacons(beacons)
//            Log.d("LLL", "${safetyScannerViewModel.uiState.value.activeMachineryList.size}")
//        }
//        else {
...
//
//    @RequiresApi(Build.VERSION_CODES.O)
//    /*private*/ fun sendNotification(distance: Double) {
//
...
//            .setContentText("Check this dog puppy video NOW! $distance")
